...
It has a property “sid” (student id) and another property “answers”. 
 The answer property holds an array that records the students answers for the quiz. 
  The array holds objects that have a question id (“qid”) property that uniquely identifies 
  the question, and an “ans” property that holds the student’s answer.
...
else if(ans1.qid === ans2.qid){ return 0;}
else {return -1;}
}
...
for (let i=0; i< quiz.key.length; i++) {
  if(sortedanswers[i].ans === quiz.key[i].ans){count++;}
}
return count;
